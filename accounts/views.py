...
#
#             if request.user.is_student and request.user.has_perm('can_view_student_profile'):
#                 return redirect('accounts:student_profile', student_id=request.user.student.id)
#             elif request.user.is_organisation and request.user.has_perm('can_view_organisation_profile'):
#                 return redirect('accounts:organisatin_profile', organization_id=request.user.organisation.id)
#             else:
