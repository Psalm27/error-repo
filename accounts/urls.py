...
from .views import student_profile, organisation_profile, login_view, activate, register_student, register_staff, \
    resetpassword_validate, forgetpassword, resetpassword_student, resetpassword_organ
